...
#SBATCH --job-name=U1_A2_16C                # job name
...
#SBATCH --nodes=16                          # number of nodes to be used
...
mpirun --mca mpi_warn_on_fork 0 python A1.py # Adjust path to your pairwise-distances python script.